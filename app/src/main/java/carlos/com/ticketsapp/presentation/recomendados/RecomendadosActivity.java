...
public class RecomendadosActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecomendadosFragment fragment = (RecomendadosFragment) getSupportFragmentManager()
